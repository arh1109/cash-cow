...
TEST_DATABASE_URL = os.environ.get(
    "TEST_DATABASE_URL",
    "postgresql+asyncpg://postgres:password@127.0.0.1:5432/atm_test"
)
...
"""
Here I will create a miniman Branch row - many endpoints (creating a robot) require a valid
branch_id in order to satisfy our foreign key constraints. 
"""
@pytest_asyncio.fixture
